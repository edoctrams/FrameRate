    ...
    <main className="fr-page relative flex min-h-screen items-center justify-center overflow-hidden px-6 py-12">
      <div className="relative w-full max-w-md">
        ...
        <div className="fr-panel rounded-lg p-7 sm:p-9">
          ...
          >
            <div>
              <label htmlFor="name" className="mb-2 block text-sm font-medium text-[#C9C9C9]">
                Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="username" className="mb-2 block text-sm font-medium text-[#C9C9C9]">
                Username
              </label>
              <input
                id="username"
            ...
            <div>
              <label htmlFor="password" className="mb-2 block text-sm font-medium text-[#C9C9C9]">
                Password
              </label>
            ...
            <div>
              <label htmlFor="confirmPassword" className="mb-2 block text-sm font-medium text-[#C9C9C9]">
                Confirm Password
              </label>
              <div className="relative">
                <input
          ...
          <p className="mt-7 text-center text-sm text-[#92979D]">
            ...
            <Link href="/login" className="font-semibold text-[#FFD369] underline decoration-[#FFD369] underline-offset-4 transition hover:text-[#EEEEEE]">
              Log in
            </Link>
          </p>
        </div>
